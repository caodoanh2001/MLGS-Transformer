...
class IUXray(PairedDataset):
    def __init__(self, image_field, text_field, img_root, ann_root, id_root=None, use_restval=True,
        ...
        roots['train'] = {
            ...
            'cap': os.path.join(ann_root, 'iu_xray_train.json')
        }
        roots['val'] = {
            'img': os.path.join(img_root, 'images'),
            'cap': os.path.join(ann_root, 'iu_xray_val.json')
        }
        roots['test'] = {
            'img': os.path.join(img_root, 'images'),
            'cap': os.path.join(ann_root, 'iu_xray_test.json')
        }
        roots['trainrestval'] = {
            'img': (roots['train']['img'], roots['val']['img']),
            'cap': (roots['train']['cap'], roots['val']['cap'])
        ...
        examples = self.train_examples + self.val_examples + self.test_examples
        super(IUXray, self).__init__(examples, {'image': image_field, 'text': text_field})
...
class MIMIC_CXR(PairedDataset):
    def __init__(self, image_field, text_field, img_root, ann_root, id_root=None, use_restval=True,
        ...
        roots['train'] = {
            'img': os.path.join(img_root, 'images'),
            'cap': os.path.join(ann_root, 'mimic_cxr_train.json')
        }
        roots['val'] = {
            'img': os.path.join(img_root, 'images'),
            'cap': os.path.join(ann_root, 'mimic_cxr_val.json')
        }
        roots['test'] = {
            'img': os.path.join(img_root, 'images'),
            'cap': os.path.join(ann_root, 'mimic_cxr_test.json')
        }
        roots['trainrestval'] = {
            'img': (roots['train']['img'], roots['val']['img']),
            'cap': (roots['train']['cap'], roots['val']['cap'])
