...
class CaptioningModelWithMasks(Module):
    def __init__(self):
        super(CaptioningModelWithMasks, self).__init__()
    ...
    def beam_search(self, visual: utils.TensorOrSequence, masks: utils.TensorOrSequence, max_len: int, eos_idx: int, beam_size: int, out_size=1,
                    return_probs=False, **kwargs):
        bs = BeamSearchWithMasks(self, max_len, eos_idx, beam_size)
        return bs.apply(visual, masks, out_size, return_probs, **kwargs)